package com.gjjf.commonservice.userCenter.config.redis;
 ...
 */
@Configuration
@ConfigurationProperties(prefix = RedisConfig.PREFIX, ignoreUnknownFields = false)
public class RedisConfig {
	...
	public int getPool_maxActive() {
		return pool_maxActive;
	}

	public void setPool_maxActive(int pool_maxActive) {
		this.pool_maxActive = pool_maxActive;
	}
